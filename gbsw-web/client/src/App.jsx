                    ...
                    <div className="content">
                        ...
                        <div>
                            ...
                            <p className="outlineTitle">
                                경북소프트웨어마이스터고등학교의 기록과 이야기가
                                모이는 곳, 경소마고실록입니다. <br />
                                이곳은 경소마고 학생이라면 누구나 자유롭게
                                문서를 작성하고 편집할 수 있는 열린 위키입니다.{" "}
                                <br />
                                교내의 행사, 동아리, 프로젝트, 개발 문화, 진로
                                이야기 등<br />
                                학교를 이루는 모든 순간들을 함께 기록해 나갑니다
                                <br />
                                <br />
                                경소마고실록은 학생들의 손으로 만들어가는 학교의
                                역사이자,
                                <br />
                                후배들에게 전해질 기술과 이야기의
                                아카이브입니다.
                            ...
                            />
                            <p className="outlineTitle">
                                1학년때에는 공통이며, 2학년부터 세부코스제로
                                나뉘어 전공을 골라 공부 할 수 있게 된다. <br />
                                세부 코스로는 게임개발, 인공지능, 웹개발 코스가
                                존재하며,
                                <br />
    ...
    return (
        <Routes>
            <Route element={<Layout isSignup={isSignup} />}>
                ...
                <Route
                    path="/notice"
                    element={<PostPage isSignup={isSignup} />}
                />
                <Route
                ...
                <Route
                    path="/notice/:id"
                    element={<PostDetails isSignup={isSignup} />}
                />
            ...
            <Route
                path="/login"
                element={
                    <LoginPage isSignup={isSignup} setIsSignup={setIsSignup} />
                }
            />
